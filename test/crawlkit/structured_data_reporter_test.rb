...
class CrawlkitStructuredDataReporterTest < Minitest::Test
  def test_reports_failures_and_report_path
    ...
    Crawlkit::StructuredData::Reporter.new(io: io, report_path: "/tmp/structured_data_report.json").report(result)
