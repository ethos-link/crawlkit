...
module Crawlkit
  class Cli
    ...
    def general_usage
      <<~TEXT
        Usage:
          crawlkit validate --base-url https://example.com [options]
          crawlkit ldjson --url https://example.com/page [options]
          crawlkit version
    ...
    def run_ldjson
      ...
      parser = OptionParser.new do |opts|
        opts.banner = "Usage: crawlkit ldjson --url https://example.com/page [options]"
      ...
      raise ConfigurationError, "Crawlkit URL is not configured" if urls.empty?
    ...
    def run_validate
      ...
      parser = OptionParser.new do |opts|
        opts.banner = "Usage: crawlkit validate --base-url https://example.com [options]"
